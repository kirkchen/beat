...
Invoke `superpowers:brainstorming` before entering the thinking stance. Brainstorming structures the ideation process; explore then carries it forward as an open-ended conversation. If unavailable (skill not installed), proceed directly into the thinking stance.
