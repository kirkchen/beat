#!/bin/bash
# Create a test project with a Beat change ready for design
# Usage: ./create-design-project.sh <project-dir>
set -euo pipefail
...
git add -A && git commit -q -m "init: test project for design pressure test"
echo "$PROJECT_DIR"
